...
# 1. Update Manifest
manifest_path = os.path.join(REPO_ROOT, "io.github.theoninesixy.FlatHMCL.yml")
...
# 2. Update Metainfo
metainfo_path = os.path.join(REPO_ROOT, "io.github.theoninesixy.FlatHMCL.metainfo.xml")
